...
@section('content')
    ...
    <div class="w-100 bg-image-index-blade">
        <div class="container">
            ...
            <div class="table-responsive pt-4">
                <table class="table w-75 m-auto table-success">
                    <thead>
                        <tr class="">
                            <th scope="col" class="py-3 text-success">Id</th>
                            <th scope="col" class="py-3 text-success">Foto</th>
                            <th scope="col" class="py-3 text-success">Titolo</th>
                            <th scope="col" class="py-3 text-success">Categoria</th>
                            <th scope="col" class="py-3 text-success">In evidenza</th>
                            <th scope="col" class="py-3 text-success">Actions</th>
                        </tr>
                    </thead>
                            ...
                            <tr>
                                ...
                                <td class="cont-img">
                                    ...
                                    @else
                                        ...
                                        <img loading="lazy" src="{{ asset('storage/' . $photo->upload_image) }}"
                                            alt="">
                                    @endif
                                </td>
