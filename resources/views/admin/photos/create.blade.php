...
@section('content')
    ...
    <div class="container mt-4">
        ...
        <div class="m-auto w-75 color-bg-form "> <!--color-bg-form opacity-7 -->
            ...
            <form action="{{ route('admin.photos.store') }}" method="post" enctype="multipart/form-data"
                    ...
                    <div class="d-flex gap-2 flex-wrap mb-4">
                        <div class="form-check form-switch" {{ $errors->has('in_evidence') ? 'is-invalid' : '' }}>
                            <input class="form-check-input" type="checkbox" role="switch" id="in_evidence"
                                name="in_evidence" value="1" {{ old('in_evidence') == 1 ? 'checked' : '' }}>
                ...
                <div class="mb-4">
                    ...
                    <div class="mb-4 d-flex">
                        <input type="file" class="form-control w-50" name="upload_image" id="upload_image"
                            placeholder="Foto" aria-describedby="uploadImageHelper" />
                        <div id="uploadImageHelper" class="form-text text-light w-50 px-2">Dimensione massima
                            della
                            foto:
                            200kb
                        </div>
